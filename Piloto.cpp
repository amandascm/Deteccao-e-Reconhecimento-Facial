...
String window_name2 = "reconhecidos";
...
int main (int argc, char** argv){
	...
	vector<int> tags; //tags para o reconhecedor de faces
	...
	//le os nomes das imagens (de uma mesma pessoa) digitados no terminal (dps do ./exe)
    ...
    reconhecer->train(imagens, tags);
    	...
    	//le video frame por frame, detecta faces e reconhece
